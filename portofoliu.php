...
<div class="container"> 
	<div class="container-fluid"> 
		<div class="row mt-4"> 
			...
			<div class="item col-sm-6 col-md-4 mb" style="padding-bottom: 6px;"> 
				<a href="images/image4.jpg" class="fancybox" data-fancybox="gallery1"> 
					<img src="images/image4.jpg" width="100%" height="100%"> 
				</a> 
			</div> 
			<div class="item col-sm-6 col-md-4 mb" style="padding-bottom: 6px;"> 
				<a href="images/image5.jpg" class="fancybox" data-fancybox="gallery1"> 
					<img src="images/image5.jpg" width="100%" height="100%"> 
				</a> 
			</div> 
			<div class="item col-sm-6 col-md-4 mb" style="padding-bottom: 6px;"> 
				<a href="images/image6.jpg" class="fancybox" data-fancybox="gallery1"> 
					<img src="images/image6.jpg" width="100%" height="100%"> 
				</a> 
			</div> 
